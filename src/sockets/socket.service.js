...
import { nobku } from "../bot/bot.service.js";
...
class SocketServices {
  ...
  async startBot({
    ...
    try {
      ...
      console.log(
        "An error occured whild trying to get sheet data, please make sure you have an internet connection!"
      );
